...
export default function TvDisplay({ dogs, palette, navigate }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-amber-100/5 rounded-full filter blur-3xl -z-10 pointer-events-none" />

      {/* Premium Signage Header (UI/UX Balanced Layout with Logo) */}
      <header className={`flex-shrink-0 flex flex-col lg:flex-row items-start lg:items-center justify-between border-b ${palette.borderCol} pb-4 mb-4 lg:mb-6 gap-4 z-10`}>
        ...
        <div className="flex items-center gap-4 md:gap-5 text-right">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className={`text-3xl md:text-4xl font-black tracking-tight leading-none ${palette.primaryText}`}>
                JOY 🐶 POLA
              </h1>
